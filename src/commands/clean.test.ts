...
describe('cleanCommand', () => {
	...
	describe('Bun workspace', () => {
		beforeEach(() => {
			...
			writeFileSync(join(testDir, 'packages', 'pkg1', 'node_modules', '.package-lock.json'), '{}');
			...
			writeFileSync(join(testDir, 'packages', 'pkg2', 'node_modules', '.package-lock.json'), '{}');
	...
	describe('pnpm workspace', () => {
		beforeEach(() => {
			...
			writeFileSync(join(testDir, 'packages', 'utils', 'node_modules', '.package-lock.json'), '{}');
		});
	...
	describe('npm workspace', () => {
		beforeEach(() => {
			...
			writeFileSync(join(testDir, 'libs', 'core', 'node_modules', '.package-lock.json'), '{}');
		});
